...
/* --------------- index object ------------------ */
class CkIndex_Sync:public CProxyElement_IrrGroup{
  public:
 ...
 */
    ...
    static int ckNew(void) { return __idx_Sync_void; }
    static void _call_Sync_void(void* impl_msg,Sync* impl_obj);
...
class CProxySection_Sync: public CProxySection_IrrGroup{
  public:
    ...
    CProxySection_Sync(const CkGroupID &_gid,const int *_pelist,int _npes) : CProxySection_IrrGroup(_gid,_pelist,_npes){  }
    CProxySection_Sync(int n,const CkGroupID *_gid, int const * const *_pelist,const int *_npes) : CProxySection_IrrGroup(n,_gid,_pelist,_npes){  }
