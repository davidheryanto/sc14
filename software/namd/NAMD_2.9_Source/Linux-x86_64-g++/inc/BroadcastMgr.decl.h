...
/* --------------- index object ------------------ */
class CkIndex_BroadcastMgr:public CProxyElement_IrrGroup{
  public:
...
/* DECLS: BroadcastMgr(void);
 */
    static int __idx_BroadcastMgr_void;
    static int ckNew(void) { return __idx_BroadcastMgr_void; }
    static void _call_BroadcastMgr_void(void* impl_msg,BroadcastMgr* impl_obj);

/* DECLS: void recvBroadcast(BroadcastMsg* impl_msg);
 */
    static int __idx_recvBroadcast_BroadcastMsg;
    static int recvBroadcast(BroadcastMsg* impl_msg) { return __idx_recvBroadcast_BroadcastMsg; }
    static void _call_recvBroadcast_BroadcastMsg(void* impl_msg,BroadcastMgr* impl_obj);
...
class CProxySection_BroadcastMgr: public CProxySection_IrrGroup{
  public:
    ...
    CProxySection_BroadcastMgr(const CkGroupID &_gid,const int *_pelist,int _npes) : CProxySection_IrrGroup(_gid,_pelist,_npes){  }
    CProxySection_BroadcastMgr(int n,const CkGroupID *_gid, int const * const *_pelist,const int *_npes) : CProxySection_IrrGroup(n,_gid,_pelist,_npes){  }
